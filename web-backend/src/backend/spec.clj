...
(s/def :bs/page pos-int?)
(s/def :bs/page-size pos-int?)
(s/def :bs/sort (s/and string? #(re-matches #"^(.+)$" %)))
(s/def :bs/filter (s/and string? #(re-matches #"^(.+)$" %)))
(s/def :bs/q (s/and string? #(re-matches #"^(.+)$" %)))
(s/def :bs/query
